...
typedef struct TreeNode
{
    ...
    TreeNode(AABB _box, bool _isLeaf, TreeNode *_parent, TreeNode *_leftChild, TreeNode *_rightChild,
             int _triangleIndex, float _cost) :
            box(_box), isLeaf(_isLeaf), parent(_parent), leftChild(_leftChild), rightChild(_rightChild),
            triangleIndex(_triangleIndex), cost(_cost)
    {}
} TreeNode;
